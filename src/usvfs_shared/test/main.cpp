...
typedef VoidAllocatorT VoidAllocator;
typedef CharAllocatorT CharAllocator;
typedef StringT SHMString;
...
template <>
inline SHMString usvfs::shared::createDataEmpty<SHMString>(const typename VoidAllocatorT& allocator) {
    return SHMString("", allocator);
}

template <>
inline void usvfs::shared::dataAssign<SHMString>(SHMString& destination, const SHMString& source) {
