...
Profile::Profile(const Profile& reference)
    : m_Directory(reference.m_Directory), m_ModListWriter(std::bind(&Profile::writeModlistNow, this)),
...
void Profile::createTweakedIniFile() {
    ...
    if (localSavesEnabled()) {
        ...
        if (!::WritePrivateProfileStringW(L"General", L"SLocalSavePath", AppConfig::localSavePlaceholder(),
