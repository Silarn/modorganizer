 ...
 *                 in the dll
 */
void InjectDLL(HANDLE processHandle, HANDLE threadHandle, LPCWSTR dllName, LPCSTR initFunction = nullptr,
               LPCVOID userData = nullptr, size_t userDataSize = 0, bool skipInit = false);
