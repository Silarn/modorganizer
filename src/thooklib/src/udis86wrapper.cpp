...
ud_t& UDis86Wrapper::obj() { return m_Obj; }
...
bool UDis86Wrapper::isRelativeJump() {
    ...
    // operand
    return (code == UD_Ijo) || (code == UD_Ijno) || (code == UD_Ijb) || (code == UD_Ijae) || (code == UD_Ijz) ||
           (code == UD_Ijnz) || (code == UD_Ijbe) || (code == UD_Ija) || (code == UD_Ijs) || (code == UD_Ijns) ||
           (code == UD_Ijp) || (code == UD_Ijnp) || (code == UD_Ijl) || (code == UD_Ijge) || (code == UD_Ijle) ||
           (code == UD_Ijg) || (code == UD_Ijcxz) || (code == UD_Ijecxz) || (code == UD_Ijrcxz) || (code == UD_Iloop) ||
           (code == UD_Iloope) || (code == UD_Iloopne) ||
